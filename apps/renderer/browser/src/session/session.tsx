...
import { createRoot } from "@terminal-effects/pixel-react";
import type { EngineKeyEvent, PixelRoot, PastedImage, Surface } from "@terminal-effects/pixel-react";
import { detect } from "@terminal-effects/terminal-adapters";
import type { Terminal } from "@terminal-effects/terminal-adapters";
