...
const INDEX_HTML: &str = include_str!("../../editor/dist/index.html");
const STYLES_CSS: &str = include_str!("../../editor/dist/assets/app.css");
const APP_JS: &str = include_str!("../../editor/dist/assets/app.js");
